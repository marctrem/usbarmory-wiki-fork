...
The [armoryctl](https://github.com/usbarmory/armoryctl) can be used to perform some of the procedures illustrated below.
...
This can also be accomplished with [armoryctl](https://github.com/usbarmory/armoryctl) `ble rc_lfck (flash|at)` command.
...
This can also be accomplished with [armoryctl](https://github.com/usbarmory/armoryctl) `ble (enable|disable)` commands.
...
This can also be accomplished with [armoryctl](https://github.com/usbarmory/armoryctl) `ble update` command.
...
[standard Debian image](https://github.com/usbarmory/usbarmory-debian-base_image).
